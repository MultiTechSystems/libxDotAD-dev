...
const uint8_t ChannelPlan_RU864::RU864_MAX_PAYLOAD_SIZE[] = { 51, 51, 51, 115, 242, 242, 242, 242, 0, 0, 0, 0, 242, 242, 0, 0 };
const uint8_t ChannelPlan_RU864::RU864_MAX_PAYLOAD_SIZE_REPEATER[] = { 51, 51, 51, 115, 222, 222, 222, 222, 0, 0, 0, 0, 222, 222, 0, 0 };
...
RxWindow ChannelPlan_RU864::GetRxWindow(uint8_t window, int8_t id) {
    RxWindow rxw;
    int index = 0;
...
uint32_t ChannelPlan_RU864::GetAckTimeout() {
...
uint32_t ChannelPlan_RU864::GetTimeOffAir()
{
    ...
    if (GetSettings()->Test.DisableDutyCycle == lora::OFF && _LBT_TimeUs == 0) {
        min = UINT_MAX;
        int8_t band = 0;
...
uint8_t ChannelPlan_RU864::DecodeBeacon(const uint8_t* payload, size_t size, BeaconData_t& data) {
